# Generated by Django 3.1 on 2020-10-15 15:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password_reset_token', models.CharField(max_length=200)),
                ('credentials', models.CharField(max_length=255)),
                ('num_classifications', models.IntegerField(default=0)),
                ('max_train_imgs_per_hr', models.IntegerField(default=60)),
                ('max_class_num', models.IntegerField(default=5)),
                ('upload_retry_limit', models.FloatField(default=0.5)),
                ...
                ('model_path', models.CharField(default=None, max_length=255, null=True)),
